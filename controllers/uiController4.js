...
exports.downloadSample = function(req,res) {
	...
	try {
		html = fs.readFileSync('./uploads/templateSelected2.html', 'utf8');
...
exports.sendEmails = function(req, res) {
	...
	var readCSVPromise = new Promise(function(resolve, reject) {
		obj.from.path(path.join(__dirname, '../uploads/sheetSelected2.csv')).to.array(function(data) {
	...
	readCSVPromise.then(function(result) {
		...
		htmlSource = fs.readFileSync("./uploads/templateSelected2.html", "utf8");
